...
::: aside
Note: technically, for the causal effect to be the differences in potential outcomes, we need an additional assumption called SUTVA. [Appendix B](details.qmd) gives more details.
:::
