...
[Further materials] that go into more detail are provided at the end of this chapter.
...
For a more advanced look at the concepts covered in this chapter, see my handout notes on:

| Handout Notes                                                                                 | Description                                                                                          |
|-----------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------|
| [Random Variables and Distributions](https://thecauses.github.io/materials/distributions.pdf) | These notes cover the building blocks of statistics in a more technical and mathematical way.        |
| Statistical Inference                                                                         | These notes cover the idea of estimators, standard errors, and p-values in more detail.              |
| Potential Outcomes Framework                                                                  | These notes provide a more mathematical and rigorous background on the potential outcomes framework. |
