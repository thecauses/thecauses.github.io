...
-   In the **related statistical topics** section, I also provide other methods that may be used to complement the main methods of causal inference.
-   In the **appendix**, I provide more technical details about some of the methods.
